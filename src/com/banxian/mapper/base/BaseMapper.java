package com.banxian.mapper.base;

import java.util.List;

/**
 * 已经实现民基本的 增,删,改,查接口,不需要重复写
 * 所有formMapper都继承这个BaseMapper
...
public interface BaseMapper {
	 ...
	 * @throws Exception
	 */
	public <T> Integer deleteById(T formMap) throws Exception;
	 ...
	 * @throws Exception
	 */
	public <T> Integer editEntity(T formMap) throws Exception;
	 ...
	 * @throws Exception
	 */
	public <T> T findById(T formMap);

	/**
	 * 1：保存数据,保存数据后返回子类对象的所有数据包括id..主建统一返回为id <br/>
	 * <b>author：</b><br/>
	 * <b>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</b><br/>
	 * <b>date：</b><br/>
	 * <b>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp2015-10-26</b><br/>
	 ...
	 * @throws Exception
	 */
	public <T> Integer addEntity(T formMap) throws Exception;
	
	
	/**
	 * 1：自定义where查询条件,返回是一个List<Map<?, ?>>集合<br/>
	 ...
	 * <b>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp4.0v</b>
	 */
	public <T> List<T> findbyFrist(T formMap);
	 ...
	 * @throws Exception
	 */
	public <T> void deleteByAttribute(T formMap) throws Exception;
	 ...
	 * @return List<Map<?, ?>>
	 */
	public <T> List<T> findByAttribute(T formMap);
}
