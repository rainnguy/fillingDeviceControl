				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" class="form-control checkRole"
							placeholder="请输入角色名" name="roleFormBean.roleName" id="name" value="${role.roleName}"/>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" class="form-control checkacc"
							placeholder="请输入roleKey" name="roleFormBean.roleKey" id="roleKey" value=${role.roleKey}>
					</div>
				</div>
				<div class="line line-dashed line-lg pull-in"></div>
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" class="form-control" placeholder="请输入角色描述"
							name="roleFormBean.roleDesc" id="description" value="${role.roleDesc}">
					</div>
				</div>
				<div class="line line-dashed line-lg pull-in"></div>
				<div class="form-group">
						...
						<div class="btn-group m-r">
							...
							<ul class="dropdown-menu dropdown-select">
								<li class=""><a href="#"><input type="radio"
										name="roleFormBean.state" value="0"<c:if test="${role.state eq 0}"> checked="checked"</c:if>>是</a></li>
								<li class="active"><a href="#"><input type="radio"
										name="roleFormBean.state" value="1" <c:if test="${role.state eq 1}"> checked="checked"</c:if>>否</a></li>
							</ul>
						</div>
					</div>
				</div>
