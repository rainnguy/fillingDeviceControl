...
<script type="text/javascript" src="${ctx}/js/system/equip/edit.js">
</script>
<style type="text/css">
.col-sm-3 {
	width: 15%;
...
<body>
	...
	<form id="form" name="form" class="form-horizontal" method="post"
		...
		<input type="hidden" class="form-control checkacc" value="${station.id}" >
		<div class="panel-body">
			<div class="form-group">
				<label class="col-sm-3 control-label">站点名称 </label>
				<div class="col-sm-9">
					<input type="text" class="form-control checkacc"
						placeholder="请输入站点名称" name="stationFormBean.orgName" id="roleName" value="${station.orgName}">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" class="form-control checkacc"
						placeholder="请输入地址" name="stationFormBean.orgAddr" id="orgAddr" value="${station.orgAddr}">
				</div>
			</div>
			<div class="line line-dashed line-lg pull-in"></div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" class="form-control" placeholder="请输入电话" 	name="stationFormBean.orgTel" id="orgTel" value="${station.orgTel}">
				</div>
			</div>
		</div>
	...
	<script type="text/javascript">
		selectStation("${station.parentId}");
	</script>
</body>
</html>